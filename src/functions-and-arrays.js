...
function uniquifyArray() {
  ...
  let wordsunified = [];
  wordsunified.forEach((element) => {
      if (!wordsunified.includes(element)) {
        wordsunified.push(element);
      }
  });
  
  console.log(wordsunified);
...
// Iteration #6: Find elements
  ...
  function doesWordExist(arr6,word) {
    if (arr6.length===0){
      return null;
    }
